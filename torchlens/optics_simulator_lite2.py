...
# import torchlens.image_ops as image_ops

from torchlens.w2rgb import wavelength_to_rgb
...
class RaytracedOptics(OpticsSimulator):
    ...
    def __init__(self,
                 ...
                 glass_weight=.01,
                 glass_catalog_path='./Database/selected_ohara_glass.csv',
    ...
    def compute_loss_out(self, rt_outputs):
        ...
        sumQ = torch.sum(Q)
        Lu = rms + lq*sumQ
        self.loss_dict = {'loss_unsup': Lu, "rms": rms}
